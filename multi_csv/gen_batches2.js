...
const outDir = 'C:/Users/richa/Dev Projects/projects/leaflet-campaign/leaflet-campaign/multi_csv/batches';
...
for (let i = 0; i < rows.length; i += BATCH_SIZE) {
  ...
  fs.writeFileSync(path.join(outDir, 'batch_' + batchNum + '.sql'), sql);
