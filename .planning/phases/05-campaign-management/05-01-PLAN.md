...
<task type="auto">
  <name>Task 6: Add response rate configuration</name>
  <files>index.html</files>
  <action>
    Add response rate inputs to campaign config modal:
    ```html
    <div class="modal-field">
    ...
    Store in campaign table (add columns if needed) or campaign_settings table.
    Update finance projections to use these rates.
  </action>
