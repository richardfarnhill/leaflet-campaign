...
- [ ] Document testing approach in `.planning/codebase/QUALITY.md`
- [ ] Create test scenarios for critical flows:
  - Enquiry record → list → map → finance
  - Campaign switch isolation
  - Route creation/deletion
  - Delivery completion
- [ ] Add Playwright or similar for E2E tests (optional - may be overkill for single-file app)
- [ ] Document manual test checklist for release
